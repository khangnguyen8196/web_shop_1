...
function drawPointsChart(containerElement) {
  ...
  var sinPoints = [];
  for (var i = 0; i < 2 * Math.PI; i += 0.4) {
    sinPoints.push([i, 2 * Math.sin(i - 0.8)]);
  }
...
function drawBubbleChart(containerElement) {
  ...
  $.each(arr, function (index, val) {
    $("#" + containerElement).append(
      "<tr><td>" + val[3] + "</td><td>" + val[2] + "</td></tr>"
    );
  });

  // Now bind function to the highlight event to show the tooltip
  // and highlight the row in the legend.
  $("#" + containerElement).bind(
    "jqplotDataHighlight",
...
function setupGallery() {
  ...
  $("ul.gallery").each(function () {
    ...
    var $fileringType = $("ul.sorting li.active a[data-type]")
      .first()
      .before(this);
...
function setupTinyMCE() {
  $("textarea.tinymce").tinymce({
    ...
    theme: "advanced",
    plugins:
      "autolink,lists,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,detail,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,advlist",
    ...
    theme_advanced_buttons2:
      "cut,copy,paste,pastetext,pasteword,|,search,replace,|,bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,link,unlink,anchor,image,cleanup,help,code,|,insertdate,inserttime,detail,|,forecolor,backcolor",
