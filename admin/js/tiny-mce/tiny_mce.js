  ...
  function b(j) {
    ...
    j.onKeyDown.add(function (n, r) {
      ...
      if (o || r.keyCode == h) {
        ...
        s = l.getParent(m.startContainer, l.isBlock);
        i.each(
          l.select("span.Apple-style-span,font.Apple-style-span", s),
          function (t) {
            var u = k.getBookmark();
            if (q) {
...
tinymce.php.Styles = function (d, f) {
...
(function (m) {
  ...
  m.php.Schema.boolAttrMap = j;
  m.php.Schema.blockElementsMap = l;
})(tinymce);
(function (a) {
  a.php.SaxParser = function (c, e) {
    var b = this,
      d = function () {};
    c = c || {};
    b.schema = e = e || new a.php.Schema();
                ...
                if (elementRule) {
                  if (elementRule.removeEmpty) {
                    ...
                    if (elementRule.paddEmpty) {
                      s.empty().append(new b.php.Node("#text", 3)).value =
                        "\u00a0";
                    }
                  }
                }
...
tinymce.php.Writer = function (e) {
  ...
  f = tinymce.php.Entities.getEncodeFunc(
...
(function (a) {
  a.php.Serializer = function (c, d) {
    var b = this,
      e = new a.php.Writer(c);
    c = c || {};
    c.validate = "validate" in c ? c.validate : true;
    b.schema = d = d || new a.php.Schema();
    b.writer = e;
...
(function (h) {
  var f = h.each,
    ...
    c = h.php.Entities,
    a = /^([a-z0-9],?)+$/i,
    g = h.php.Schema.blockElementsMap,
    i = /^[ \t\r\n]*$/;
  ...
  c.create("tinymce.dom.Selection", {
    ...
    getContent: function (g) {
      ...
      if (h.cloneContents) {
        ...
        if (b(h.item) || b(h.phpText)) {
          l.innerHTML = "<br>" + (h.item ? h.item(0).outerHTML : h.phpText);
...
(function (d) {
  ...
  d.create("tinymce.ui.ColorSplitButton:tinymce.ui.SplitButton", {
    ...
    displayColor: function (g) {
      var f = this;
      c.setStyle(f.id + "_detail", "backgroundColor", g);
      f.value = g;
    },
    postRender: function () {
      var f = this,
      ...
      c.setStyle(f.id + "_detail", "backgroundColor", f.value);
    },
    destroy: function () {
      this.parent();
...
(function (m) {
  ...
  m.create("tinymce.Editor", {
    ...
    setupIframe: function () {
      ...
      q.parser = new m.php.DomParser(v, q.schema);
      ...
      q.parser.addNodeFilter("p,h1,h2,h3,h4,h5,h6,div", function (t, z) {
        ...
        while (A--) {
          B = t[A];
          if (B.isEmpty(s)) {
            B.empty().append(new m.php.Node("br", 1)).shortEnded = true;
          }
        }
      });
    ...
    setContent: function (u, s) {
      ...
      if (s.format !== "raw") {
        u = new m.php.Serializer({}, r.schema).serialize(r.parser.parse(u));
      }
      s.content = m.trim(u);
  ...
  c.EditorCommands = function (n) {
    ...
    u({
      ...
      mceInsertContent: function (B, I, K) {
        ...
        y = n.parser;
        J = new c.php.Serializer({}, n.schema);
...
(function (a) {
  a.Formatter = function (V) {
    ...
    function b(W) {
      return (
        W.nodeType === 1 &&
        (W.face === "mceinline" || W.style.fontFamily === "mceinline")
      );
    }
    function R(W) {
      return W ? M[W] : M;
    ...
    function T(Z, ah, ac) {
      ...
      function Y(ao, au, ar, aq, am) {
        ...
        O(ao.childNodes, function (ay, ax) {
          if (
            ay.nodeName === "SPAN" &&
            c.getAttrib(ay, "data-mce-type") == "bookmark"
          ) {
      ...
      function ak(al) {
        ...
        K.walk(al, function (ao) {
          O(ao, function (ap) {
            ...
            if (
              ap.nodeType === 1 &&
              V.dom.getStyle(ap, "text-decoration") === "underline" &&
              ap.parentNode &&
              i(ap.parentNode) === "underline"
            ) {
              U(
                {
                  deep: false,
        ...
        if (af) {
          if (af.length === p) {
            ...
            for (ag = 0; ag < af.length; ag++) {
              if (
                al === "attributes" ? c.getAttrib(ai, af[ag]) : L(ai, af[ag])
              ) {
                return ak;
              }
            }
    ...
    function H(W) {
      return (
        W && W.nodeType == 1 && W.getAttribute("data-mce-type") == "bookmark"
      );
    }
    function u(aa, Z) {
      var W, Y, X;
      function ac(af, ae) {
        ...
        if (
          !ag(
            c.parseStyle(c.getAttrib(af, "style")),
        ...
        if (!P.isListening && af()) {
          ...
          O("onKeyDown,onKeyUp,onKeyPress,onMouseUp".split(","), function (ah) {
            V[ah].addToTop(function (ai, al) {
              ...
              if (
                af() &&
                !a.dom.RangeUtils.compareRanges(P.lastRng, q.getRng())
              ) {
                var aj = false;
